...
import 'package:sefty/chat_module/message_text_field.dart';
import 'package:sefty/chat_module/singleMessage.dart';
             ...
             builder: (BuildContext context,AsyncSnapshot<QuerySnapshot> snapshot){
              if (snapshot.hasData) {
                if (snapshot.data!.docs.length<1) {
                 ...
                 Text(
                  type=="parent"?
                  "Talk with Child":"Talk with Parent",style: TextStyle(fontSize: 30),),
                  );
                }
                return Container(
